...
def save_perceptron_models():
    ...
    np.savez("models/face_perceptron_weights.npz", weights=face_model_perceptron.weights,
             bias=face_model_perceptron.bias)
    ...
    np.savez("models/digit_perceptron_weights.npz", weights=digit_model_perceptron.weights,
             bias=digit_model_perceptron.bias)


def save_custom_nn_models():
    face_model_customNN = CustomNN(input_size=face_train_data.shape[1], hidden_size1=256, hidden_size2=128,
                                   output_size=2)
    ...
    digit_model_customNN = CustomNN(input_size=digit_train_data.shape[1], hidden_size1=256, hidden_size2=128,
                                    output_size=10)
